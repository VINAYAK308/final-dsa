...
// Enter keyword and meaning: apple fruit
// Want to continue (1/0): 1

// Enter keyword and meaning: banana yellowfruit
// Want to continue (1/0): 1

// Enter keyword and meaning: cherry redfruit
...
// 4
//  Enter the word for which u want to modify the meaning: banana
//  Enter the new meaning: longfruit

//  The keyword is____banana___ and its modified meaning is-longfruit

// Enter ur choice
// ...

// 5
//  Enter the word u want to search: cherry

//  The word---cherry---is present in the BST 

// Enter ur choice
// ...

// 6
//  Enter the word u want to delete: apple
...
//  The max comparisons for the word:  2 
